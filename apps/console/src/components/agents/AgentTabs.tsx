...
import { CallTransferTab } from "@/src/components/agents/tabs/CallTransferTab";
import { EvaluationTab } from "@/src/components/agents/tabs/EvaluationTab";
...
const TABS = [
  ...
  { id: "flow", label: "Flow Builder", icon: GitFork },
  { id: "voice", label: "Models & Voices", icon: AudioLines },
  { id: "transfer", label: "Call Transfer", icon: PhoneForwarded },
  { id: "evaluation", label: "Evaluator & Simulator", icon: Sparkles },
  ...
  return (
    <Tabs value={current} onValueChange={onChange} className="w-full min-w-0">
      ...
      <TabsContent value="transfer" className="mt-6 min-w-0">
        <CallTransferTab agentId={agentId} />
      </TabsContent>
      <TabsContent value="evaluation" className="mt-6 min-w-0">
        <EvaluationTab agentId={agentId} />
      </TabsContent>
